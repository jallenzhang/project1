...
class ExportGuiMianJunZiModelAnimation : ExportModelAnimation
{
...
//     }
    ...
    #endregion
    [MenuItem("Assets/Export Model Animation/拷贝鬼面君子")]
    public static void copy()
    {
        GameObject GuiMianJunZi = GameObject.Find("QuanFaNiang");
        GameObject GuiMianJunZi20003 = GameObject.Find("20001");
    ...
    [MenuItem("Assets/Export Model Animation/导出鬼面君子 / 动作")]
    static void ExportGuiMianJunZi()
    {
        ExportGuiMianJunZiModelAnimation a = new ExportGuiMianJunZiModelAnimation();
        a.Export();
    }
    ...
    public override void SetAnimationEvents(AnimationClip dstClip)
    {
        ...
        switch (dstClip.name)
        {
            ...
            case "ChargeAttackR":
                {
                    dstClip.wrapMode = WrapMode.ClampForever;
                    animationEventManager.AddAnimationEvent(11 / dstClip.frameRate, "AnimationEventBoxIn"); // 激活碰撞体 //
                    animationEventManager.AddAnimationEvent(16 / dstClip.frameRate, "AnimationEventBoxIn1"); //触发碰撞关闭//
            ...
            case "WalkR":
                {
                    ...
                    animationEventManager.AddAnimationEvent(20 / dstClip.frameRate, "AnimationMoveWardEventR");
                }
                break;
            case "WalkBackR":
                {
