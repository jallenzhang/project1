...
class ExportQuanFaNiangModelAnimation : ExportModelAnimation
{
    ...
    [MenuItem("Assets/Export Model Animation/拷贝组件/拳法娘")]
    public static void copy()
    {
        GameObject GuiMianJunZi = GameObject.Find("MuTouRen");
    ...
    [MenuItem("Assets/Export Model Animation/导出拳法娘 / 动作")]
    static void ExportQuanFaNiang()
    {
        ExportQuanFaNiangModelAnimation a = new ExportQuanFaNiangModelAnimation();
        a.Export();
    }
    ...
    public override void SetAnimationEvents(AnimationClip dstClip)
    {
        ...
        switch (dstClip.name)
        {
            ...
            case "ChargeAttackR":
                {
                    ...
                    animationEventManager.AddAnimationEvent(13 / dstClip.frameRate, "AnimationEventBoxIn1"); // 关闭撞体 //
                    ...
                    animationEventManager.AddAnimationEvent(23 / dstClip.frameRate, "AnimationEventCanRemoveCoolDown");//cooldown帧限制//
                }
                break;
            case "JumpBackR":
            case "JumpR":
            ...
            case "Attack1R":
                {
                    animationEventManager.AddAnimationEvent(9 / dstClip.frameRate, "AnimationEventBoxIn"); //激活碰撞体//
            ...
            case "WalkR":
                {
                    ...
                    animationEventManager.AddAnimationEvent(14 / dstClip.frameRate, "AnimationMoveWardEventL");
                    //animationEventManager.AddAnimationEvent(22 / dstClip.frameRate, "AnimationMoveWardEventR");
                }
                break;
            case "WalkBackR":
                {
            ...
            case "Skill1R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(20 / dstClip.frameRate, "AnimationEventBoxIn1"); //激死碰撞体//
            ...
            case "Skill2R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(6 / dstClip.frameRate, "AnimationEventBoxIn"); //激活碰撞体//

                    animationEventManager.AddAnimationEvent(14 / dstClip.frameRate, "AnimationEventBoxIn1"); //激死碰撞体//
            ...
            case "Skill3R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(18 / dstClip.frameRate, "AnimationEventBoxIn1"); //不能攻击//
            ...
            case "AttackSquat2R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(10f / dstClip.frameRate, "AnimationEventBoxIn1"); //触发碰撞体碰撞//
                    animationEventManager.AddAnimationEvent(0 / dstClip.frameRate, "AnimationEventMovePlay");//人物位移
                    animationEventManager.AddAnimationEvent(3 / dstClip.frameRate, "AnimationEventMoveStop");//人物位移停止
                }
                break;
            ...
            case "AirAttackR":
                {
                    dstClip.wrapMode = WrapMode.ClampForever;
                    animationEventManager.AddAnimationEvent(5 /  dstClip.frameRate, "AnimationEventBoxIn"); //开始攻击判定//
                    animationEventManager.AddAnimationEvent(12 / dstClip.frameRate, "AnimationEventBoxIn1"); //不能攻击//
