...
class ExportPanGuanJiModelAnimation : ExportModelAnimation
{
...
//     }
    ...
    [MenuItem("Assets/Export Model Animation/导出判官吉/ 动作")]
    static void ExportYuLuoCha()
    {
        ExportPanGuanJiModelAnimation a = new ExportPanGuanJiModelAnimation();
        a.Export();
    }
    ...
    public override void SetAnimationEvents(AnimationClip dstClip)
    {
        ...
        switch (dstClip.name)
        {
            ...
            case "ChargeAttackR":
                {
                    ...
                    animationEventManager.AddAnimationEvent(8 / dstClip.frameRate, "AnimationEventBoxIn3"); //触发碰撞关闭//
            ...
            case "Attack4R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(8 / dstClip.frameRate, "AnimationEventBoxIn1");//关闭碰撞体//
                    animationEventManager.AddAnimationEvent(3 / dstClip.frameRate, "AnimationEventMovePlay");//人物位移
            ...
            case "Skill1R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(11 / dstClip.frameRate, "AnimationEventBoxIn2"); //第二次攻击//
                    animationEventManager.AddAnimationEvent(20 / dstClip.frameRate, "AnimationEventBoxIn3"); //第三次次攻击//
                    animationEventManager.AddAnimationEvent(5 / dstClip.frameRate, "AnimationEventBoxIn1"); //播放技能特效//
            ...
            case "Skill2R":
                {
                    dstClip.wrapMode = WrapMode.ClampForever;
                    animationEventManager.AddAnimationEvent(10 / dstClip.frameRate, "AnimationEventBoxIn"); //播放技能特效//
                }
                break;
            case "Skill3R":
                {
                    ...
                    animationEventManager.AddAnimationEvent(7 / dstClip.frameRate, "AnimationEventBoxIn1"); //开始攻击判定//
                    animationEventManager.AddAnimationEvent(10 / dstClip.frameRate, "AnimationEventBoxIn2"); //开始攻击判定//
                    animationEventManager.AddAnimationEvent(15 / dstClip.frameRate, "AnimationEventBoxIn3"); //开始攻击判定//
                    animationEventManager.AddAnimationEvent(20 / dstClip.frameRate, "AnimationEventBoxIn4"); //攻击结束//
