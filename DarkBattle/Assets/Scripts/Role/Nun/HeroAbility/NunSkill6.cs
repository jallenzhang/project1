...
public class NunSkill6 : AbilityBase
{
    public NunSkill6(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("NunSkill6 " + this.Level + " power " + this.SkillData.name);
