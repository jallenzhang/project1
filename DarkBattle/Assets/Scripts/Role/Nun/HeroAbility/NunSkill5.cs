...
public class NunSkill5 : AbilityBase
{
    public NunSkill5(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("NunSkill5 " + this.Level + " power " + this.SkillData.name);
