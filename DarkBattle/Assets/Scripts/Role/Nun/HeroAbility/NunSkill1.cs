...
public class NunSkill1 : AbilityBase
{
    public NunSkill1(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("NunSkill1 " + this.Level + " power " + this.SkillData.name);
