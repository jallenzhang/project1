...
public class NunSkill2 : AbilityBase
{
    public NunSkill2(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("NunSkill2 " + this.Level + " power " + this.SkillData.name);
