...
public class NunSkill7 : AbilityBase
{
    public NunSkill7(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("NunSkill7 " + this.Level + " power " + this.SkillData.name);
