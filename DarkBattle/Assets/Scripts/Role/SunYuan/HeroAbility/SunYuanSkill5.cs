...
public class SunYuanSkill5 : AbilityBase
{
    public SunYuanSkill5(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill5 " + this.Level + " power " + this.SkillData.name);
