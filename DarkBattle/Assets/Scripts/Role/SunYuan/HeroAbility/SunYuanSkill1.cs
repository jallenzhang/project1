...
public class SunYuanSkill1 : AbilityBase
{
    public SunYuanSkill1(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill1 " + this.Level + " power " + this.SkillData.name);
