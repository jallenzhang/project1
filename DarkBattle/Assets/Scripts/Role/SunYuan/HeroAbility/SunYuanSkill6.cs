...
public class SunYuanSkill6 : AbilityBase
{

    public SunYuanSkill6(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill6 " + this.Level + " power " + this.SkillData.name);
