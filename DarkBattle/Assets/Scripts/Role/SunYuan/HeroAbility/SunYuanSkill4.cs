...
public class SunYuanSkill4 : AbilityBase
{
    public SunYuanSkill4(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill4 " + this.Level + " power " + this.SkillData.name);
