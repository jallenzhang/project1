...
public class SunYuanSkill3 : AbilityBase
{
    public SunYuanSkill3(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill3 " + this.Level + " power " + this.SkillData.name);
