...
public class SunYuanSkill7 : AbilityBase
{
    public SunYuanSkill7(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("SunYuanSkill7 " + this.Level + " power " + this.SkillData.name);
