...
public class GuiMianSkill2 : AbilityBase
{
    public GuiMianSkill2(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("GuiMianSkill2 " + this.Level + " power " + this.SkillData.name);
