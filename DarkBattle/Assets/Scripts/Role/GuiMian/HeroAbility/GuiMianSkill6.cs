...
public class GuiMianSkill6 : AbilityBase
{
    public GuiMianSkill6(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("GuiMianSkill6 " + this.Level + " power " + this.SkillData.name);
