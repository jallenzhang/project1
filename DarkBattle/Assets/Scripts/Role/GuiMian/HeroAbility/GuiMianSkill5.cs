...
public class GuiMianSkill5 : AbilityBase
{
    public GuiMianSkill5(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("GuiMianSkill5 " + this.Level + " power " + this.SkillData.name);
