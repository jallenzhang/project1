...
public class GuiMianSkill4 : AbilityBase
{
    public GuiMianSkill4(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("GuiMianSkill4 " + this.Level + " power " + this.SkillData.name);
