...
public class GuiMianSkill7 : AbilityBase
{
    public GuiMianSkill7(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("GuiMianSkill7 " + this.Level + " power " + this.SkillData.name);
