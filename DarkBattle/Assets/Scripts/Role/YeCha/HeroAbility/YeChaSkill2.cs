...
public class YeChaSkill2 : AbilityBase {
    public YeChaSkill2(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill2 " + this.Level + " power " + this.SkillData.name);
