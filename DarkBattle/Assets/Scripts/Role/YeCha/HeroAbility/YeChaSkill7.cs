...
public class YeChaSkill7 : AbilityBase {
    public YeChaSkill7(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill7 " + this.Level + " power " + this.SkillData.name);
