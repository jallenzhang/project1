...
public class YeChaSkill1 : AbilityBase
{
    public YeChaSkill1(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill1 " + this.Level + " power " + this.SkillData.name);
