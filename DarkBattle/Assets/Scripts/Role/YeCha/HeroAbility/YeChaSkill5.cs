...
public class YeChaSkill5 : AbilityBase {
    public YeChaSkill5(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill5 " + this.Level + " power " + this.SkillData.name);
