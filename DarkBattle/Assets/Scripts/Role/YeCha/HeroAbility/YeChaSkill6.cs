...
public class YeChaSkill6 : AbilityBase {
    public YeChaSkill6(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill6 " + this.Level + " power " + this.SkillData.name);
