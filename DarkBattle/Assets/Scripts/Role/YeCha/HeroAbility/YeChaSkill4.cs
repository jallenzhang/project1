...
public class YeChaSkill4 : AbilityBase {

	public YeChaSkill4(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill4 " + this.Level + " power " + this.SkillData.name);
