...
public class YeChaSkill3 : AbilityBase {
    public YeChaSkill3(int level, int skillId, int idx, RoleBase parent)
    ...
    {
        Debug.logger.Log("YeChaSkill3 " + this.Level + " power " + this.SkillData.name);
