...
public class SoldierSkill2 : AbilityBase {

	public SoldierSkill2(int level, int skillId, int idx, RoleBase parent) : base(skillId, idx, parent)
    {
        Level = level;
        Init();
    }
    ...
    {
        Debug.logger.Log("SoldierSkill2 " + this.Level + " power " + this.SkillData.name);
