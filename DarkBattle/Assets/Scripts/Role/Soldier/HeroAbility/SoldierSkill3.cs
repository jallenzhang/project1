...
public class SoldierSkill3 : AbilityBase {

	public SoldierSkill3(int level, int skillId, int idx, RoleBase parent) : base(skillId, idx, parent)
    {
        Level = level;
        Init();
    }
    ...
    {
        Debug.logger.Log("SoldierSkill3 " + this.Level + " power " + this.SkillData.name);
