...
public class SoldierSkill6 : AbilityBase {

	public SoldierSkill6(int level, int skillId, int idx, RoleBase parent) : base(skillId, idx, parent)
    {
        Level = level;
        Init();
    }
    ...
    {
        Debug.logger.Log("SoldierSkill6 " + this.Level + " power " + this.SkillData.name);
