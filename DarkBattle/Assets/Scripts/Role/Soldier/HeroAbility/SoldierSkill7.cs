...
public class SoldierSkill7 : AbilityBase {

	public SoldierSkill7(int level, int skillId, int idx, RoleBase parent) : base(skillId, idx, parent)
    {
        Level = level;
        Init();
    }
    ...
    {
        Debug.logger.Log("SoldierSkill7 " + this.Level + " power " + this.SkillData.name);
