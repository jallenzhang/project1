...
public class SoldierSkill4 : AbilityBase {

	public SoldierSkill4(int level, int skillId, int idx, RoleBase parent) : base(skillId, idx, parent)
    {
        Level = level;
        Init();
    }
    ...
    {
        Debug.logger.Log("SoldierSkill4 " + this.Level + " power " + this.SkillData.name);
