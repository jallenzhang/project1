...
public class EffectBlur : MonoBehaviour {
    ...
    {
        //依次赋值  
        ChangeValue = 0;// DownSampleNum;
        ChangeValue2 = 0;// BlurSpreadSize;
    ...
    {
        //着色器实例不为空，就进行参数设置  
        if (CurShader != null && GameData.Instance.BattleSceneActionFlag.HasFlag((long)StateDef.BattleActionFlag.OnAttacking))
        {
            //【0】参数准备  
