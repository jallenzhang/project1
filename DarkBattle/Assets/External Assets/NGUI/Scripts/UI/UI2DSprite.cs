...
public class UI2DSprite : UIBasicSprite
{
    ...
    [HideInInspector][SerializeField] UnityEngine.Sprite mAlphaSprite;
    ...
    /// <summary>
    /// UnityEngine.Sprite alpha pass drawn by this widget.
    /// </summary>

    public UnityEngine.Sprite alphaSprite2D
    {
        get
        {
            return mAlphaSprite;
        ...
        set
        {
            if (mAlphaSprite != value || value == null)
            {
                RemoveFromPanel();
                mAlphaSprite = value;
                MarkAsChanged();
