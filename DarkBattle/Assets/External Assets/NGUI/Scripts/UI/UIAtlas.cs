...
public class UIAtlas : MonoBehaviour
{
    ...
    /// <summary>
    /// Alpha Texture used by the atlas.
    /// </summary>
    ...
    public Texture alphaTexture
    {
        get
        {
            if (mReplacement != null) return mReplacement.alphaTexture;
            if (material != null && material.HasProperty("_AlphaTex"))
                return material.GetTexture("_AlphaTex");
            return null;
        }
    }
