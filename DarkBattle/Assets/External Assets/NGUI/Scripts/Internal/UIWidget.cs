...
public class UIWidget : UIRect
{
    ...
    /// <summary>
    /// Alpha texture used by the widget.
    /// </summary>

    public virtual Texture alphaTexture
    {
        get
        {
            Material mat = material;
            return (mat != null && mat.HasProperty("_AlphaTex")) ? mat.GetTexture("_AlphaTex") : null;
        }
        set
        {
            throw new System.NotImplementedException(GetType() + " has no alphaTexture setter");
        }
    }
    ...
    public virtual int textureWidth
    {
        get
        {
            return (mainTexture != null) ? mainTexture.width : 0;
        }
        set
        {
            throw new System.NotImplementedException(GetType() + " has no textureWidth setter");
        }
    }
    ...
    public virtual int textureHeight
    {
        get
        {
            return (mainTexture != null) ? mainTexture.height : 0;
        }
        set
        {
            throw new System.NotImplementedException(GetType() + " has no textureHeight setter");
        }
    }
    ...
    virtual public Vector4 flippedBorder { get { return Vector4.zero; } set { } }
